...
@Component({
  ...
  templateUrl: './ifr-outstanding.component.html',
  styleUrls: ['./ifr-outstanding.component.scss'],
  providers: [MessageService, ConfirmationService]
})
export class FraudOutstandingComponent {
  ...
  outstanding(): void {
    this.fraudService.getOutstanding().subscribe(
      (response: IFR[]) => {
        this.fraudo = response;
      },
      (error: any) => {
        // Handle error
      }
