...
@Component({
  ...
  templateUrl: './ifr-new.component.html',
  styleUrls: ['./ifr-new.component.scss'],
  providers: [MessageService, ConfirmationService]
})
export class FraudNewComponent {
  ...
  new(): void {
    this.fraudService.getNew().subscribe(
      (response: IFR[]) => {
        this.fraudn = response;
      },
      (error: any) => {
        // Handle error
      }
