...
@Component({
  ...
  templateUrl: './ifr-closed.component.html',
  styleUrls: ['./ifr-closed.component.scss'],
  providers: [MessageService, ConfirmationService]
})
export class FraudClosedComponent {
  ...
  closed(): void {
    this.fraudService.getClosed().subscribe(
      (response: IFR[]) => {
        this.fraudc = response;
      },
      (error: any) => {
        // Handle error
      }
