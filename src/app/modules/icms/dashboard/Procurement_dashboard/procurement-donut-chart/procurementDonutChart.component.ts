...
@Component({
  selector: "procurementDonutChart",
  templateUrl: "./procurementDonutChart.component.html",
  styleUrls: ["./procurementDonutChart.component.scss"]
})
export class ProcurementDonutChartComponent {
