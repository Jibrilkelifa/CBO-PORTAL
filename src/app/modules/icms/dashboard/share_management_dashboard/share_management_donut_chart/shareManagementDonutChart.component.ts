...
@Component({
  selector: "shareManagementDonutChart",
  templateUrl: "./shareManagementDonutChart.component.html",
  styleUrls: ["./shareManagementDonutChart.component.scss"]
})
export class ShareManagementDonutChartComponent {
