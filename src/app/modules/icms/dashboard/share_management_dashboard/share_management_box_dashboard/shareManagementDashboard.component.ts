...
@Component({
  selector: 'shareManagementDashboard',
  templateUrl: './shareManagementDashboard.component.html',
  styleUrls: ['./shareManagementDashboard.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default,
})
export class ShareManagementDashboardComponent {
  public allDatas: any;
