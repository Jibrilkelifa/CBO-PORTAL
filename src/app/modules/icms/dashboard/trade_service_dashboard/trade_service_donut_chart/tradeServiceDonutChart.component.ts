...
@Component({
  selector: "tradeServiceDonutChart",
  templateUrl: "./tradeServiceDonutChart.component.html",
  styleUrls: ["./tradeServiceDonutChart.component.scss"]
})
export class TradeServiceDonutChartComponent {
