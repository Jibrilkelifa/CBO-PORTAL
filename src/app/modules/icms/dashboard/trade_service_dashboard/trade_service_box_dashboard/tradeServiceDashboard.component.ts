...
@Component({
  selector: 'tradeServiceDashboard',
  templateUrl: './tradeServiceDashboard.component.html',
  styleUrls: ['./tradeServiceDashboard.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default,
})
export class TradeServiceDashboardComponent {
  public allDatas: any;
