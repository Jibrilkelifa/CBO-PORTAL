...
@Component({
  ...
  templateUrl: './cipm-expired.component.html',
  styleUrls: ['./cipm-expired.component.scss']
})
export class CIPMExpiredComponent {
  public cipms: CIPM[] = [];
  public cipme: CIPM[] = [];
  public cipmee: CIPM[] = [];
  public cipmR: CIPM[] = [];
  ...
  expired(): void {
    this.cipmService.getExpired().subscribe(
      (response: CIPM[]) => {
        this.cipmee = response;
      },
      (error: any) => {
        // Handle error
      }
