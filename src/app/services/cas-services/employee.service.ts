...
export class EmployeeService {
  ...
  public getEmployeeByName(searchTerm: string): Observable<any>{
    this.init();
    return this.http.get<any>(`${this.emsAPIBaseUrl}/getEmployeeByName/${searchTerm}`, this.httpOptions)
  }

  getDummyData() {
    this.init();
    return this.http.get(`${this.apiServiceUrl}/employee/employee.json`, this.httpOptions);
  }
