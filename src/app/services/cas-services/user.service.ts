...
import { RoleService } from '../cas-services/role.service';
import { TimeService } from '../cas-services/time.service';
...
export class UserService {
  ...
  public countUser(username: string): Observable<any> {
    this.init();
    return this.http.get<void>(`${this.apiServiceUrl}/user/count/${username}`, this.httpOptions)
  }
  public changeOTP(userId: number, changeOTPForm: any): Observable<any> {
    this.init();
    return this.http.patch<any>(`${this.apiServiceUrl}/user/changeOTP`,
      {
        userId: userId,
        newPassword: changeOTPForm.newPassword
      },
      this.httpOptions)
  }
  public resetUserPassword(userId: number): Observable<any> {
    this.init();
    return this.http.patch<any>(`${this.apiServiceUrl}/user/resetPassword`,
      {
        userId: userId,
        newPassword: null
      },
