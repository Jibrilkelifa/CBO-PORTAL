...
class NgxIndexedDBService {
    ...
    instanciateConfig(dbConfig, isOnlyConfig) {
        ...
        if (((_a = dbConfig.isDefault) !== null && _a !== void 0 ? _a : false) && this.defaultDatabaseName) {
            // A default DB is already configured, throw an error
            throw new Error('NgxIndexedDB: Only one database can be set as default');
        }
        if ((((_b = dbConfig.isDefault) !== null && _b !== void 0 ? _b : false) && !this.defaultDatabaseName) || isOnlyConfig) {
    ...
    selectDb(databaseName) {
        databaseName = databaseName !== null && databaseName !== void 0 ? databaseName : this.defaultDatabaseName;
        if (!databaseName) {
    ...
    bulkPut(storeName, items) {
        ...
        return new Observable((obs) => {
            openDatabase(this.indexedDB, this.dbConfig.name, this.dbConfig.version)
                ...
                .catch((reason) => {
                transaction === null || transaction === void 0 ? void 0 : transaction.abort();
                obs.error(reason);
            });
        });
    }
