...
ArrowDownLeftIcon.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ArrowDownLeftIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
ArrowDownLeftIcon.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.4", type: ArrowDownLeftIcon, isStandalone: true, selector: "ArrowDownLeftIcon", usesInheritance: true, ngImport: i0, template: `
    ...
    `, isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ArrowDownLeftIcon, decorators: [{
            type: Component,
            args: [{
