...
ArrowDownRightIcon.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ArrowDownRightIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
ArrowDownRightIcon.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.4", type: ArrowDownRightIcon, isStandalone: true, selector: "ArrowDownRightIcon", usesInheritance: true, ngImport: i0, template: `
    ...
    `, isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ArrowDownRightIcon, decorators: [{
            type: Component,
            args: [{
