...
CaretRightIcon.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CaretRightIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
CaretRightIcon.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.4", type: CaretRightIcon, isStandalone: true, selector: "CaretRightIcon", usesInheritance: true, ngImport: i0, template: `
    ...
    `, isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CaretRightIcon, decorators: [{
            type: Component,
            args: [{
