...
ArrowRightIcon.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ArrowRightIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
ArrowRightIcon.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.4", type: ArrowRightIcon, isStandalone: true, selector: "ArrowRightIcon", usesInheritance: true, ngImport: i0, template: `
    ...
    `, isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ArrowRightIcon, decorators: [{
            type: Component,
            args: [{
